...
const ContactManagement = () => {
  const [contacts, setContacts] = useState([
    {
      ...
      message: "Hi Ashish, I came across your portfolio and I'm impressed with your work. We have an opening for a Full Stack Developer position at TechCorp. Would love to discuss this opportunity with you.",
      date: "2024-12-15",
      status: "unread",
      source: "portfolio"
    },
    {
      ...
      message: "Hello Ashish, we're looking for a developer to build a real-time monitoring dashboard similar to your AirVibe project. Could we schedule a call to discuss the requirements?",
      date: "2024-12-14",
      status: "read",
      source: "linkedin"
    },
    {
      ...
      message: "Hi! I'm a fellow developer and startup founder. Your IoT projects caught my attention. Would you be interested in collaborating on a smart agriculture project?",
      date: "2024-12-13",
      status: "replied",
      source: "github"
    },
    {
      ...
      firstName: "Sneha",
      lastName: "Gupta",
      email: "sneha.gupta@designstudio.com",
      phone: "+91 6543210987",
      subject: "UI/UX Collaboration",
      message: "Your portfolio design is amazing! I'm a UI/UX designer and would love to collaborate on future projects. Let's connect!",
      date: "2024-12-12",
      status: "read",
      source: "portfolio"
    },
    {
      ...
      phone: "+91 5432109876",
      subject: "Enterprise Solution Development",
      message: "We're impressed with your microservices expertise. We have a large-scale enterprise project that might interest you. Can we schedule a meeting?",
      date: "2024-12-11",
      status: "unread",
      source: "referral"
    }
  ...
  const stats = [
    ...
    { label: 'This Week', value: contacts.filter(c => new Date(c.date) > new Date(Date.now() - 7*24*60*60*1000)).length, color: 'text-neon-purple' }
  ];
                ...
                <Card className={`cyber-border p-4 hover:shadow-glow-cyan transition-all duration-300 ${contact.status === 'unread' ? 'border-yellow-400' : ''}`}>
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="text-right">
                      <div className="text-xs text-foreground/40">{contact.date}</div>
                  ...
                  <div className="flex gap-3">
                    {selectedContact.status !== 'replied' && (
                      <Button
                        ...
                        className="cyber-button bg-green-600 hover:bg-green-700 flex-1"
                      >
                    ...
                    <Button
                      ...
                      className="cyber-button bg-primary hover:bg-primary/90 flex-1"
                    >
